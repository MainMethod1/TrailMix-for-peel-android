...
public class PlaceProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.mainmethod.trailmix1.PlaceProvider";
    ...
    String mKey = "key=AIzaSyC1h_nlIZTycaxewCYPaU2VxkR_LSemQIQ";
        ...
        case SEARCH:
            ...
            try {
                ...
                for(int i=0;i<list.size();i++){
                    ...
                    // Get Place details
                    jsonPlaceDetails = getPlaceDetails(hMap.get("place_id"));
